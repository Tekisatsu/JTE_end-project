    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            for (int i = 0; i < items.getLength(); i++) {
                ...
                XPathExpression exprItemDesc = xpath.compile("./description/text()");
                NodeList itemsDesc = (NodeList) exprItemDesc.evaluate(doc, XPathConstants.NODESET);
                for (i = 0; i < itemsDesc.getLength(); i++) {
                    System.out.println(itemsDesc.item(i));
                }
                System.out.println("-----------------------");
            }
        } catch (Exception e) {
